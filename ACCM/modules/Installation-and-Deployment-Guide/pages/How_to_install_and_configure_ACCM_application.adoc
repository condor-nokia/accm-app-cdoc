...
that will be used to access {app-short-name}. Refer to xref:Installation-and-Deployment-Guide:appendices/ACCM_Exposed_Interfaces.adoc[{app-short-name} Exposed Interfaces] section to know how each value impact the exposed interfaces.
|No
|""
...
* *ALTIPLANO_PUBLIC_IP_LIST (Optional):* List of IPs/Hostnames apart from the configured in the ALTIPLANO_SERVER variable that will be used to access WNP (For example in NAT scenarios). Refer to xref:Installation-and-Deployment-Guide:appendices/ACCM_Exposed_Interfaces.adoc[{app-short-name} Exposed Interfaces] section to know how each value impact the exposed interfaces.
