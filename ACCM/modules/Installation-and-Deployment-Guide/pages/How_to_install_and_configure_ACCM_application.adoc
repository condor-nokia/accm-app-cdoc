...
Aquí tienes todas las variables procesadas siguiendo el formato de tu ejemplo. He mantenido la coherencia con los valores que pasaste (descripciones genéricas o específicas según el contexto de la variable).

Puedes copiar y pegar este bloque directamente en tu archivo .adoc:
AsciiDoc
...
|Suffix for download activity names.
|Yes
|"DL"
|String

|ACTIVITY_SUFFIX_UPGRADE_SPINE
|Suffix for spine upgrade activities.
|Yes
|"UPG_SP"
|String

|ACTIVITY_SUFFIX_UPGRADE_CP_BATCH
|Suffix for CP batch upgrade activities.
|Yes
|"UPG_CPB"
|String

|ACTIVITY_SUFFIX_UPGRADE_ACC_BATCH
|Suffix for ACC batch upgrade activities.
|Yes
|"UPG_ACB"
|String

|ACTIVITY_SUFFIX_UPGRADE_HEADEND
|Suffix for headend upgrade activities.
|Yes
|"UPG_HE"
|String

|ACTIVITY_SUFFIX_UPGRADE_OLT_BATCH
|Suffix for OLT batch upgrade activities.
|Yes
|"UPG_OLTB"
|String
...
|FOOTER_MESSAGE
|Version message displayed in the application footer.
|Yes
|"26.1.0-MAIN-0001"
|String

|ALTIPLANO_AC_PATH_URL
|Base path for Altiplano access control.
|Yes
|"/nokia-altiplano-ac"
|String
...
|REACT_APP_FOOTER_MESSAGE
|Footer message for the React application UI.
|Yes
|"26.1.0-MAIN-0001"
|String
